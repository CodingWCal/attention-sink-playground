...
try {
  ...
  // Radial "hub": token 0 at the centre, the rest spaced on a ring (XZ plane);
  // ring grows with token count so labels never collide. Arcs bow UP in y.
