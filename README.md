...
**▶ [Open the live app in molab](https://molab.marimo.io/notebooks/nb_ZoQHqZYu4dDZ6CihMoNukT/app)** — the interactive notebook, rendered and ready to explore.

_Prefer the source? [Open in molab](https://molab.marimo.io/notebooks/nb_ZoQHqZYu4dDZ6CihMoNukT) to read the code, click **Run it now**, or fork your own copy._
