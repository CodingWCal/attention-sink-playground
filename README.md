...
**▶ [Open the live app in molab](https://molab.marimo.io/notebooks/nb_K8kqGBUiHA9zADF7peqUDs/app)** — the interactive notebook, rendered and ready to explore.

_Prefer the source? [Open in molab](https://molab.marimo.io/notebooks/nb_K8kqGBUiHA9zADF7peqUDs) to read the code, click **Run it now**, or fork your own copy._
